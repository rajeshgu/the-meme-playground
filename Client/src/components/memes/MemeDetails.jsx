...
const MemeDetail = () => {
  ...
  // Calculate engagement rate separately for cleaner code
  const engagementRate = meme.views 
    ? Math.min(100, Math.floor(((meme.votes + meme.commentsCount) / meme.views) * 100))
    : 0;
    ...
    <Box maxW="800px" mx="auto" p={4}>
      ...
      <Box mb={8}>
        ...
        <SimpleGrid columns={3} spacing={4}>
          ...
          <StatBox label="Engagement" value={`${engagementRate}%`} />
        </SimpleGrid>
      </Box>
